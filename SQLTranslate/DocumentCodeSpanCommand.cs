...
namespace SQLTranslate
{
    ...
    internal sealed class DocumentCodeSpanCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("5d11f7db-2a54-4d71-bbdb-5d269d75989e");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            _ = GetSeAsync(OnSearch);

        }
        private string OnSearch(string text)
        {
            return text + " okkk";
        }

        async Task GetSeAsync(Func<string, string> modify)
        {
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
            DTE dte = (DTE)await ServiceProvider.GetServiceAsync(typeof(DTE)).ConfigureAwait(true);
            Assumes.Present(dte);
